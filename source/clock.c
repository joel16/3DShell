...
void digitalTime(void)
{
	...
	if ((hours >= 1) && (hours < 10))
	{
		...
		screen_draw_stringf((393 - width), 1, 0.44f, 0.44f, RGBA8(TopScreen_bar_colour.r, TopScreen_bar_colour.g, TopScreen_bar_colour.b, 255), "%2i:%02i %s", hours, minutes, amOrPm ? "AM" : "PM");
	}
	else
	{
