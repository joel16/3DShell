...
char temp_arr[250], theme_dir[250], font_dir[250];

char background_path[250], selector_path[250], folder_path[250], file_path[250], audio_path[250], app_path[250],
	txt_path[250], system_path[250], zip_path[250], img_path[250], uncheck_path[250], options_path[250], properties_path[250], 
	deletion_path[250];
...
struct bottomScreen_bar_colour 
{
   int	r;
   int	g;
   int	b;
...
struct bottomScreen_text_colour 
{
   int	r;
   int	g;
   int	b;
...
struct options_title_text_colour 
{
   int	r;
   int	g;
   int	b;
...
struct settings_title_text_colour 
{
   int	r;
   int	g;
   int	b;
...
struct settings_text_min_colour 
{
   int	r;
   int	g;
   int	b;
