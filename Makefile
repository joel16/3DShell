...
BUILD		:= build
SOURCES     := source source/audio source/ftp source/graphics source/menus
DATA        := data
INCLUDES    := include include/audio include/dr_libs include/ftp include/graphics include/menus
